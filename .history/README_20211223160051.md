...
This is the project for the third course in the [Udacity C++ Nanodegree Program](https://www.udacity.com/course/c-plus-plus-nanodegree--nd213): Memory Management. This repo contains my personal solution.
...
> The aim of the project is to analyze and improve the program with memory management techniques. Although the program can be executed and works as intended, no advanced concepts as discussed in this course have been used; there are currently no smart pointers, no move semantics and not much thought has been given to ownership or memory allocation.
...
### Task 2 : The Rule Of Five :heavy_check_mark:
...
### Task 3 : Exclusive Ownership 2 :heavy_check_mark:
...
### Task 4 : Moving Smart Pointers :heavy_check_mark:
...
### Task 5 : Moving the ChatBot :heavy_check_mark:
...
ChatBot Constructor (No Memory allocation)
ChatBot Move Constructor Operator
