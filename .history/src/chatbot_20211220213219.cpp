 ...
 *        ChatBot instance is passed by value, as this creates a copy. This has a two fold advantage:
 * a) This is for optimization, better let the compiler make the copy in the parameter list.
 * b)
 * @param chatbot  
 * @return ChatBot&
 */
 ...
 * associated.
 *
 * @param A type ChatBot::ChatBot
 * @param B type ChatBot::ChatBot
 */
