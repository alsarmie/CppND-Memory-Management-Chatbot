...
ChatBot::~ChatBot() {
  ...
  //If Chatbot destructor gets called, it is still possible to call GetChatLogicHandle/GetImageHandle afterwards (unless the chatbot pointer is set to nullptr right afterwards.)
...
// Copy Constructor
ChatBot::ChatBot(const ChatBot &chatbot):_currentNode(chatbot._currentNode),_rootNode(chatbot._rootNode),_chatLogic {}
