...
public:
  ...
  // getter / setter we don't need to pass the smart pointer as ownership belongs to chatgui
  unique_ptr< *GetChatLogicHandle() { return _chatLogic.get(); }
