...
ChatBot::ChatBot(ChatBot &&chatbot) noexcept:ChatBot(){// default constructor initialization
  swap(*this, chatbot);
}
  ChatBotChatBot &operator=(ChatBot &&chatbot) noexcept; // Move assignment Operator
