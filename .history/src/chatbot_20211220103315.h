...
public:
  ...
  ~ChatBot();                    // Destructor
  ChatBot(const ChatBot &chatbot, std::string filename="../images/chatbot_new.png"); // Copy Constructor
  ChatBot &operator=(const ChatBot &chatbot,
                     std::string filename="../images/chatbot_new.png"); // Copy assignment operator
