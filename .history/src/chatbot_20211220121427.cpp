...
/// STUDENT CODE
////
ChatBot::ChatBot(ChatBot &chatbot, int type = 0) {

  // 0 exclusive copy | 1 deep copy
  switch (type) {
  case 0: // exclusive copy
    std::cout << "ChatBot Copy Constructor (Exclusive)" << std::endl;
    ...
    break;
  case 1: // deep copy
    std::cout << "ChatBot Copy Constructor (Deep)" << std::endl;
...
ChatBot &ChatBot::operator=( ChatBot &chatbot) {
  ...
  *_image = *chatbot._image;
  _currentNode = chatbot._currentNode;
  _rootNode = chatbot._currentNode;
  _chatLogic = chatbot._chatLogic;chatbot._image = nullptr;
    // data handles (not owned)
    chatbot._currentNode = nullptr;
    chatbot._chatLogic = nullptr;
    chatbot._rootNode = nullptr;
