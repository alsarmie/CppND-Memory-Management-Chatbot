...
public:
  ...
  friend void swap(ChatBot &A, ChatBot &B) {
    ...
    swap(A._minKeywordSize, B._minKeywordSize);
  }
  ...
  void SetMinKeywordSize(int minKeywordSize) {
    _minKeywordSize = minKeywordSize;
  }
  int GetMinKeywordSize() const { return _minKeywordSize; }
  // communication
