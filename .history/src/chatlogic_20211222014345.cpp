...
/**
 * @brief Finds a specific token (keyword) in a token list if it exists. The obtained token is added to a graphedge instance.
 *
 * @tparam T
...
/**
 * @brief Read and parse answer graph elements into nodes and edges. Responsible for creating Create instance of Chatbot in the stack, then move it to the root node.
 * 
