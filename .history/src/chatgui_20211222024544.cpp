...
/**
 * @brief Construct a new Chat Bot Frame:: Chat Bot Frame object ->wxWidgets FRAME
 * 
 * @param title 
 */
...
/**
 * @brief Handle on Enter keystroke. Retrieve text from text control,add new user text to dialog,delete text in text control,send user text to chatbot
 * 
