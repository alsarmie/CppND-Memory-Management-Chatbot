 ...
 * Seem to rank the same. As well, the following was avoided due to optimization reasons:
 *
 ...
 * }
 *
 *ChatBot &ChatBot::operator=(ChatBot chatbot) could work for both cases (move and copy).
 *
 */
//!
/**
