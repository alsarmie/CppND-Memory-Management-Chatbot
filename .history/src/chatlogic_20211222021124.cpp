...
/**
 * @brief Wrapper method to send a message to Chatbot instance. Calls ReceiveMessageFromUser.
 * 
...
/**
 * @brief Wrapper method to receive (print) a message from Chatbot instance into the Panel Dialog. Calls PrintChatbotResponse.
 * 
 * @param message std::string 
 */
...
/**
 * @brief Getter method to retrieve the chatbot image handle. Calls GetImageHandle
 * 
 * @return wxBitmap* 
 */
