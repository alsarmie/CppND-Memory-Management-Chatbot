 ...
 * a two fold advantage: a) This is for optimization, better let the compiler
...
/**
 * @brief Move Assignment operator for ChatBot Class object (same effect as regular copy assignment per this particular implementation)
 *
 * @param chatbot
 * @return ChatBot::ChatBot&
 */
ChatBot &ChatBot::operator=(ChatBot &&chatbot) noexcept :ChatBot(){ swap(*this,chatbot)return *this; }
