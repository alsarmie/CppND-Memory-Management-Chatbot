...
/**
 * @brief Construct a new Chat Bot:: Chat Bot object  WITHOUT memory allocation (default)
 * 
 */
ChatBot::ChatBot()
...
/**
 * @brief Construct a new Chat Bot:: Chat Bot object WITH memory allocation (_image member)
 * 
...
// Copy Constructor
/**
 * @brief Copy Construct a new Chat Bot:: Chat Bot object
 * 
 * @param chatbot 
 */
