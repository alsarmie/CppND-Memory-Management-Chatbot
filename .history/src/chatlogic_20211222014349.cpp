...
/**
 * @brief Read and parse answer graph elements into nodes and edges. Responsible for creating an instance of Chatbot in the stack, then move it to the root node.
 * 
