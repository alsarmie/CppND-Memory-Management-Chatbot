...
void ChatLogic::AddAllTokensToElement(std::string tokenID, tokenlist &tokens,
  ...
  while (true) {
    ...
    if (token != tokens.end()) {
      ...
      // Check the smallest keyword size
      if(tokenID=="KEYWORD")
      (token->second.size() < minKeySize) ? minKeySize = token->second.size()
                                          : false;
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename) {
  // To keep track the smallest keyword size
  int minKeySize{INF};
        ...
        if (idToken != tokens.end()) {
          ...
          if (type->second == "NODE") {
            ...
            if (newNode == _nodes.end()) {
              ...
              AddAllTokensToElement("ANSWER", tokens, minKeySize, **newNode);
            }
          ...
          if (type->second == "EDGE") {
            ...
            if (parentToken != tokens.end() && childToken != tokens.end()) {
              ...
              AddAllTokensToElement("KEYWORD", tokens, minKeySize*(edge.get()));
  ...
  chatBot.SetMinKeywordSize(minKeySize);
...
/**
 * @brief Setter method for ChatBotPanelDialog handle.
 *
 * @param panelDialog ChatBotPanelDialog *
 */
...
/**
 * @brief Setter method for ChatBot handle.
 *
...
/**
 * @brief Wrapper method to send a message to Chatbot instance. Calls
...
/**
 * @brief Wrapper method to receive (print) a message from Chatbot instance into
 * the Panel Dialog. Calls PrintChatbotResponse.
 *
 * @param message std::string
 */
...
/**
 * @brief Getter method to retrieve the chatbot image handle. Calls
 * GetImageHandle
 *
 * @return wxBitmap*
 */
