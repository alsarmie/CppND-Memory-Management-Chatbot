...
/**
 * @brief Populates _childEdges vector with GraphEdge unique pointers. Move semantics enabled.
 * R.32: Take a unique_ptr<widget> parameter to express that a function assumes
* ownership of a widget
 * @param edge 
 */
...
/**
 * @brief Method to move chatbot resource to caller's node. Move semantics enabled.
 * 
...
/**
 * @brief Method to move chatbot resource to a new node. Calls MoveChatbotHere. Move semantics enabled.
 * 
