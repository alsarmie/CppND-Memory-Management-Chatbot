...
/**
 * @brief Construct a new Chat Bot Frame Image Panel:: Chat Bot Frame Image
 * Panel object
 *
...
/**
 * @brief Render background image of chatbot window.
 *
 * @param dc wxDC &
 */
...
/**
 * @brief Construct a new Chat Bot Panel Dialog:: Chat Bot Panel Dialog object
 *
...
/**
 * @brief Destroy the Chat Bot Panel Dialog:: Chat Bot Panel Dialog object
 *
 */
...
/**
 * @brief Add a single dialog element.
 *
 * @param text wxString
 * @param isFromUser bool
 */
...
/**
 * @brief Convert string into wxString and add dialog element.
 *
...
/**
 * @brief Construct a new Chat Bot Panel Dialog Item:: Chat Bot Panel Dialog
 * Item object
 *
 * @param parent wxPanel *
 * @param text wxString
 * @param isFromUser bool
 */
ChatBotPanelDialogItem::ChatBotPanelDialogItem(wxPanel *parent, wxString text,
  ...
  //   wxT("BLUE")));
  this->SetBackgroundColour(wxSystemSettings::GetColour(wxColor(*wxTransparentColour));
}
